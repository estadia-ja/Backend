...
describe('test user service', () => {
  ...
  describe('createUser', () => {
    it('should create a new user', async () => {
      ...
      const createUserWithPhones = {
        ...createUser,
        phones: [{ id: 'phone-cuid', phone: userTest.phones[0] }],
      };
  ...
  describe('updateUser', () => {
    it('should throw error if user does not exist', async () => {
      ...
      await expect(
        userService.updateUser(1, { name: 'Lucas' })
  ...
  describe('deleteUser', () => {
    it('should throw error if user does not exist', async () => {
      ...
      await expect(userService.deleteUser(2)).rejects.toThrowError(
        'Usuário não encontrado'
      );
  ...
  describe('getImage', () => {
    ...
    it('should throw error if user does not exists', async () => {
      ...
      await expect(userService.getImage(99)).rejects.toThrow(
    ...
    it('should throw error if user has no image', async () => {
      ...
      await expect(userService.getImage(19)).rejects.toThrow(
