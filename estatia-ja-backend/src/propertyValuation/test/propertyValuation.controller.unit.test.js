...
describe('test propertyValuation controller', () => {
  ...
  describe('create', () => {
    ...
    it('should create a valuation and return it with status 201', async () => {
      ...
      propertyValuationService.createPropertyValuation.mockResolvedValue(
        mockCreatedValuation
      );
      ...
      ).toHaveBeenCalledWith(reserveId, userId, valuationData);
  ...
  describe('getByProperty', () => {
    it('should return a list of valuations with status 200', async () => {
      ...
      propertyValuationService.getValuationsByProperty.mockResolvedValue(
        mockValuations
      );
      ...
      expect(
        propertyValuationService.getValuationsByProperty
      ).toHaveBeenCalledWith('prop-1');
      expect(mockRes.status).toHaveBeenCalledWith(200);
      expect(mockRes.json).toHaveBeenCalledWith(
        mockValuations.map((p) => p.toJson())
      );
    });
  ...
  describe('delete', () => {
    it('should delete a valuation and return status 204', async () => {
      ...
      expect(
        propertyValuationService.deletePropertyValuation
      ).toHaveBeenCalledWith('val-to-delete', 'fake-user-id');
